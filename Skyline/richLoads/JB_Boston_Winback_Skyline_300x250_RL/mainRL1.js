...
function animate() {
  ...
  tl.set(['#h1, #h2'], {y:"20px"})
  tl.set(['#building'], {x:"80px"})
  tl.set(['#cloud'], {x:"60px"})
  tl.set(['#plane1'], {x:"210px"})
  tl.set(['#paper2'], {x:"147px", y:"-98"})
  tl.set(['#paper3'], {x:"-137px", y:"132"})
  ...
  .to('#plane1', 2.5, { x:"0",  ease: "power1.out",}, "frame1")
  .addLabel('frame2', '5')
  ...
  .to('#paper3', 0.5, { autoAlpha: 1, x:"100", y: "-61", ease: Power1.easeOut }, "<")
